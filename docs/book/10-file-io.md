...
artifact: A program reads a file line-by-line using `getline`, prints each line, handles EOF and missing trailing newline correctly
status: stub
related_milestone: docs/implementation/tasks/M04-file-io.md
...
> Session ID: `M4-1` · Phase B · ~60 min · [Underlying milestone](../implementation/tasks/M04-file-io.md)

## What you'll learn

`fopen` / `getline` / EOF; line-buffered vs unbuffered; the NUL termination distinction

## What you'll build

A program reads a file line-by-line using `getline`, prints each line, handles EOF and missing trailing newline correctly

## Before you start

Run chapter 09's artifact to confirm the baseline. Exact verification commands land when this chapter is drafted.
...
The companion teaching-notes file at [`docs/teaching/notes/10-file-io.md`](../teaching/notes/10-file-io.md) gets filled during the live session.
...
- [Underlying milestone](../implementation/tasks/M04-file-io.md)
