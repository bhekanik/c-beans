...
artifact: v0.1.0 tag is pushed; LICENSE / CHANGELOG / README polish landed; install instructions work end-to-end on a fresh machine; demo GIF
status: stub
...
> Session ID: `M13-3` · Phase F · ~90 min · [Underlying milestone](../implementation/tasks/M13-polish.md)

## What you'll learn

The difference between "a project that builds" and "a project someone else can install"; the documentation that matters for adoption; **public release**

## What you'll build

v0.1.0 tag is pushed; LICENSE / CHANGELOG / README polish landed; install instructions work end-to-end on a fresh machine; demo GIF

## Before you start

Run chapter 32's artifact to confirm the baseline. Exact verification commands land when this chapter is drafted.
...
The companion teaching-notes file at [`docs/teaching/notes/33-ship-v01.md`](../teaching/notes/33-ship-v01.md) gets filled during the live session.
