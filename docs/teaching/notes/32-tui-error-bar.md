...
# Teaching notes — Chapter 32: Error rendering in TUI

> **Status:** chapter is a stub. This notes file is also a stub; both get filled when the live session runs.

## Concept anchor

(To be filled when the chapter is drafted. The session plan in `docs/teaching/sessions.md` row `M13-2` has the planned scope.)
...
The artifact for this chapter: Errors from the store/parser surface in a status bar at the bottom of the TUI; auto-clear after 5 seconds
