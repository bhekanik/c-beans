...
# Teaching notes — Chapter 12: String tokens — escapes

> **Status:** chapter is a stub. This notes file is also a stub; both get filled when the live session runs.

## Concept anchor

(To be filled when the chapter is drafted. The session plan in `docs/teaching/sessions.md` row `M5-2` has the planned scope.)
...
The artifact for this chapter: The tokenizer correctly decodes `\n`, `\t`, `\"`, `\\`, `é` (é); rejects invalid UTF-8
