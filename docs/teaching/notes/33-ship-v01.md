...
# Teaching notes — Chapter 33: Ship v0.1

> **Status:** chapter is a stub. This notes file is also a stub; both get filled when the live session runs.

## Concept anchor

(To be filled when the chapter is drafted. The session plan in `docs/teaching/sessions.md` row `M13-3` has the planned scope.)
...
The artifact for this chapter: v0.1.0 tag is pushed; LICENSE / CHANGELOG / README polish landed; install instructions work end-to-end on a fresh machine; demo GIF
