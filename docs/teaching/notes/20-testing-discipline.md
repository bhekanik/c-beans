...
# Teaching notes — Chapter 20: Testing as a discipline

> **Status:** chapter is a stub. This notes file is also a stub; both get filled when the live session runs.

## Concept anchor

(To be filled when the chapter is drafted. The session plan in `docs/teaching/sessions.md` row `TDD-1` has the planned scope.)
...
The artifact for this chapter: `ctest --test-dir build --output-on-failure` runs all chapter 04-19 smoke tests; they pass
